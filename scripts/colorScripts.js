	...
	single: function(filterVal) { // Builds single palette requests
		...
		var singleTableString = "<tr class='paletteColor'></tr> \
								 <tr id='paletteOptions' class='paletteOptions'> \
									<td id='D1-dyn' class='tabOptions dynamic trans2'></td><td id='D1-con' class='tabOptions convert trans2'></td> \
									<td id='D2-dyn' class='tabOptions dynamic trans2'></td><td id='D2-con' class='tabOptions convert trans2'></td> \
									<td id='D3-dyn' class='tabOptions dynamic trans2'></td><td id='D3-con' class='tabOptions convert trans2'></td> \
									<td id='D4-dyn' class='tabOptions dynamic trans2'></td><td id='D4-con' class='tabOptions convert trans2'></td> \
									<td id='D5-dyn' class='tabOptions dynamic trans2'></td><td id='D5-con' class='tabOptions convert trans2'></td> \
								 </tr> \
